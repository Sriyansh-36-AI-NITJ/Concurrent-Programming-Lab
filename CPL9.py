...
Original file is located at
    https://colab.research.google.com/drive/160GXSRIlPVdU6cWi76rFvj_t2OaOtRal
"""
...
# IMPORTANT: Move the model to the CUDA device
...
# Disable gradient calculation for inference to save memory and compute
with torch.no_grad():
